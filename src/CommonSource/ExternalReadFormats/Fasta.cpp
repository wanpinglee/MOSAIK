...
#define QUALITY_FILE_OPEN(filename) (mAreBaseQualitiesCompressed ? (FILE *)(mInQualityZStream = gzopen(filename, "rb"))                   : mInQualityStream = fopen(filename, "rb"))
...
#define QUALITY_STREAM              (mAreBaseQualitiesCompressed ? (FILE *)mInQualityZStream                                            : mInQualityStream)
